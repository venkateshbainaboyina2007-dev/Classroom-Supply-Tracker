              ...
              <TableBody>
                {isLoading ? (
                  ...
                  supplies.map((supply) => {
                    ...
                    return (
                      <TableRow key={supply.id} className={isOutOfStock ? "bg-destructive/5 hover:bg-destructive/10" : ""}>
                        ...
                        <TableCell>
                          {isOutOfStock ? (
                            ...
                            <Badge className="bg-orange-100 text-orange-800 hover:bg-orange-100 border-orange-200 flex w-fit items-center gap-1">
